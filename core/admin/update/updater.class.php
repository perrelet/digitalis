...
class Updater {
	...
	protected $remote_json 		= 'https://digitalis.ca/plugins/update/digitalis/info';
	protected $plugin_slug 		= DIGITALIS_PLUGIN_SLUG;
	protected $plugin_base 		= DIGITALIS_PLUGIN_BASE;
	protected $version			= DIGITALIS_VERSION;
